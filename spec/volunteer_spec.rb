...
describe Volunteer do
  ...
  describe '#==' do
    it 'checks for equality based on the name of a volunteer' do
      volunteer1 = Volunteer.new({:name => 'Jane', :proj_id => 1, :id => nil})
      volunteer2 = Volunteer.new({:name => 'Jane', :proj_id => 1, :id => nil})
  ...
  context '.all' do
    ...
    it 'returns all volunteers' do
      volunteer1 = Volunteer.new({:name => 'Jane', :proj_id => 1, :id => nil})
      volunteer1.save
      volunteer2 = Volunteer.new({:name => 'Joe', :proj_id => 1, :id => nil})
      volunteer2.save
  ...
  describe '.find' do
    it 'returns a volunteer by id' do
      ...
      volunteer2 = Volunteer.new({:name => 'Joe', :proj_id => 1, :id => nil})
      volunteer2.save
      expect(Volunteer.find(volunteer1.id)).to eq volunteer2
    end
  end
end